                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]" border="0" style="cellspacing:0;color:#000;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px 15px 5px 0;">{{ $item['product']['title'] }}</td>
                                                    <td style="padding: 0 15px;">{{ $item['quantity'] }}</td>
                                                    <td style="padding: 0 0 0 15px;" align="right">₦{{ number_format($item['price'],2) }}</td>
                                                </tr>
                                                @endforeach
                                                ...
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    ...
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">₦{{ number_format($order->total_amount,2) }}</td>
                                                </tr>
                                            </table>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:0;word-break:break-word;">
                                                            ...
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                               Address: No 3, Ayanboye Street, Anthony Village, Lagos
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:10;word-break:break-word;">
                                                            ...
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                Tel:
                                                                <a href="" style="color:#575757">(+234) 8072663033,</a>
                                                                <a href="" style="color:#575757">08022225582</a>
                                                            </div>
